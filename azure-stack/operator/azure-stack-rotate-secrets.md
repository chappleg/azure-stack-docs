...
- ADFS<sup>*</sup>
- Graph<sup>*</sup>
- Azure Container Registry<sup>**</sup>

<sup>*</sup>Applicable when using Active Directory Federated Services (AD FS).
<sup>**</sup>Applicable when Azure Container Registry is installed.
...
2. Prepare a new set of replacement external certificates:
   ...
   - If Azure Container Registry is installed, also generate also prepare a replacement external certificate for it using the steps outlined in [Install Azure Container Registry on Azure Stack Hub](https://docs.microsoft.com/en-us/azure-stack/operator/container-registries-install?view=azs-2108#generate-your-certificate)
